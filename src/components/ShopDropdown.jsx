    ...
    <div className="relative hidden md:block">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-100 space-y-3 p-2 text-sm bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100 animate-fade ">
          <Link to="/vols" className=" px-4 py-2 flex items-center justify-start gap-3 text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition font-medium" onClick={() => setOpen(false)}>
            <Plane className="w-5"/> Vols
          </Link>
          <Link to="/hotels" className="flex items-center justify-start gap-3 px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition font-medium" onClick={() => setOpen(false)}>
            <Hotel className="w-5"/> Hotels
          </Link>
          <Link to="/sejours" className="flex items-center justify-start gap-3 px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition font-medium" onClick={() => setOpen(false)}>
          ...
          <hr className="h-px bg-gray-300 border-0 mt-6 mb-5" />
            ...
            <Link to="/historique" className="flex items-center justify-start gap-3 px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition font-medium" onClick={() => setOpen(false)}>
            <ExternalLink className="w-5"/> historiques
          </Link>
        </div>
      )}
    </div>

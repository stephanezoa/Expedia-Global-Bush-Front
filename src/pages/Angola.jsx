...
import angolaHero from "../assets/images/angola-hero.jpg";

// Images par défaut pour les circuits - utilise tes propres images ou placeholders
const defaultCircuitImages = {
  'AGO1': "https://images.unsplash.com/photo-1589552950456-75eeaf3c7b1e?w=800&q=80",
  'AGO2': "https://images.unsplash.com/photo-1589552950453-2a2d3f4f5b5b?w=800&q=80",
  'AGO3': "https://images.unsplash.com/photo-1589552950455-75eeaf3c7b1e?w=800&q=80",
  'AGO4': "https://images.unsplash.com/photo-1589552950456-75eeaf3c7b1f?w=800&q=80",
  'AGO5': "https://images.unsplash.com/photo-1589552950457-75eeaf3c7b1e?w=800&q=80",
  'AGO6': "https://images.unsplash.com/photo-1589552950458-75eeaf3c7b1e?w=800&q=80",
  'AGO7': "https://images.unsplash.com/photo-1589552950459-75eeaf3c7b1e?w=800&q=80",
  'AGO8': "https://images.unsplash.com/photo-1589552950460-75eeaf3c7b1e?w=800&q=80",
  'AGO9': "https://images.unsplash.com/photo-1589552950461-75eeaf3c7b1e?w=800&q=80"
};
...
function MapModal({ tour, isOpen, onClose }) {
  ...
  const circuitItineraries = {
    'AGO1': ['Luanda', 'Benguela', 'Lobito'],
    'AGO2': ['Luanda', 'Huambo', 'Kuito'],
    'AGO3': ['Luanda', 'Malanje', 'Uíge', 'Soyo'],
    'AGO4': ['Namibe', 'Tômbwa', 'Parque da Kissama'],
    'AGO5': ['Luanda', 'Cabinda', 'Soyo'],
    'AGO6': ['Luanda', 'Benguela', 'Huambo', 'Lubango', 'Namibe'],
    'AGO7': ['Luanda', 'Sumbe', 'Porto Amboim'],
    'AGO8': ['Luanda', 'Caxito', 'Ndalatando'],
    'AGO9': ['Lubango', 'Namibe', 'Parque do Iona'],
  };

  const currentItinerary = circuitItineraries[tour.id] || ['Luanda', 'Benguela'];
        ...
        <div className="flex h-[calc(90vh-120px)]">
          ...
          <div className="w-2/3 border-r p-4 bg-gray-50">
            <div className="relative w-full h-full">
              ...
              <div className="border-4 border-gray-800 rounded-lg h-full relative bg-gradient-to-b from-blue-50 to-yellow-50">
                {/* Océan Atlantique */}
                <div className="absolute left-0 top-0 w-full h-1/3 bg-gradient-to-b from-blue-200 to-blue-100">
                  <div className="absolute top-4 left-4 text-blue-800 font-bold text-lg">
                ...
                {/* Plateau Central */}
                <div className="absolute left-0 top-1/3 w-full h-1/3 bg-gradient-to-b from-green-100 to-green-50 border-t border-b border-gray-300">
                ...
                {/* Sud - Région Désertique */}
                <div className="absolute left-0 bottom-0 w-full h-1/3 bg-gradient-to-t from-yellow-100 to-yellow-50 border-t border-gray-300">
                  <div className="absolute bottom-4 left-4 text-yellow-800 font-bold">
                    <div className="flex items-center">
                      <svg className="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute inset-0">
                  {/* Luanda */}
                  <div className="absolute left-[20%] top-[15%] group">
                  ...
                  {/* Benguela */}
                  <div className="absolute left-[15%] top-[25%] group">
                    <div className="w-8 h-8 bg-red-600 rounded-full border-4 border-white shadow-lg flex items-center justify-center cursor-pointer hover:scale-125 transition-transform">
                      <div className="w-4 h-4 bg-white rounded-full"></div>
                    </div>
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black text-white px-3 py-1 rounded text-sm font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {/* Huambo */}
                  <div className="absolute left-[40%] top-[50%] group">
                  ...
                  {/* Lubango */}
                  <div className="absolute left-[50%] top-[75%] group">
                    <div className="w-8 h-8 bg-blue-600 rounded-full border-4 border-white shadow-lg flex items-center justify-center cursor-pointer hover:scale-125 transition-transform">
                      <div className="w-4 h-4 bg-white rounded-full"></div>
                    </div>
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black text-white px-3 py-1 rounded text-sm font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {/* Namibe */}
                  <div className="absolute left-[25%] top-[80%] group">
                    <div className="w-8 h-8 bg-blue-600 rounded-full border-4 border-white shadow-lg flex items-center justify-center cursor-pointer hover:scale-125 transition-transform">
                      <div className="w-4 h-4 bg-white rounded-full"></div>
                    </div>
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black text-white px-3 py-1 rounded text-sm font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {/* Lobito */}
                  <div className="absolute left-[18%] top-[20%] group">
                    <div className="w-8 h-8 bg-blue-600 rounded-full border-4 border-white shadow-lg flex items-center justify-center cursor-pointer hover:scale-125 transition-transform">
                      <div className="w-4 h-4 bg-white rounded-full"></div>
                    </div>
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black text-white px-3 py-1 rounded text-sm font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {/* Malanje */}
                  <div className="absolute left-[60%] top-[40%] group">
                    <div className="w-8 h-8 bg-blue-600 rounded-full border-4 border-white shadow-lg flex items-center justify-center cursor-pointer hover:scale-125 transition-transform">
                      <div className="w-4 h-4 bg-white rounded-full"></div>
                    </div>
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black text-white px-3 py-1 rounded text-sm font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {/* Uíge */}
                  <div className="absolute left-[65%] top-[35%] group">
                    <div className="w-8 h-8 bg-blue-600 rounded-full border-4 border-white shadow-lg flex items-center justify-center cursor-pointer hover:scale-125 transition-transform">
                      <div className="w-4 h-4 bg-white rounded-full"></div>
                    </div>
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black text-white px-3 py-1 rounded text-sm font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {/* Soyo */}
                  <div className="absolute left-[30%] top-[10%] group">
                    <div className="w-8 h-8 bg-blue-600 rounded-full border-4 border-white shadow-lg flex items-center justify-center cursor-pointer hover:scale-125 transition-transform">
                      <div className="w-4 h-4 bg-white rounded-full"></div>
                    </div>
                    <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-black text-white px-3 py-1 rounded text-sm font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {/* Chutes de Kalandula */}
                  <div className="absolute left-[55%] top-[45%] group">
                    <div className="w-10 h-10 bg-blue-800 rounded-full border-4 border-white shadow-lg flex items-center justify-center cursor-pointer hover:scale-125 transition-transform">
                  ...
                  {tour.id === 'AGO1' && (
                    <>
                      {/* Ligne Luanda → Benguela → Lobito */}
                      <div className="absolute left-[20%] top-[15%] w-[5%] h-[10%] border-t-2 border-dashed border-red-500"></div>
                      <div className="absolute left-[18%] top-[20%] w-0 h-[5%] border-l-2 border-dashed border-red-500"></div>
                  ...
                  {tour.id === 'AGO3' && (
                    <>
                      {/* Ligne Luanda → Malanje → Uíge → Soyo */}
                      <div className="absolute left-[20%] top-[15%] w-[40%] h-[25%] border-t-2 border-dashed border-red-500"></div>
                      <div className="absolute left-[60%] top-[35%] w-0 h-[5%] border-l-2 border-dashed border-red-500"></div>
                      <div className="absolute left-[65%] top-[35%] w-[35%] h-0 border-t-2 border-dashed border-red-500"></div>
                      <div className="absolute left-[30%] top-[35%] w-0 h-[25%] border-l-2 border-dashed border-red-500"></div>
                    </>
                  )}
                </div>
                ...
                <div className="absolute bottom-4 right-4 bg-white/95 p-4 rounded-lg shadow-lg border border-gray-200 max-w-xs">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      <div className="w-8 h-8 bg-blue-800 rounded-full border-2 border-white mr-3 flex items-center justify-center">
                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M14 6l-1-2-1 2-2 2 2 2 1 2 1-2 2-2-2-2zM6 10l-2-2 2-2 2 2-2 2zM22 10l-2-2 2-2 2 2-2 2zM16 6l2-2 2 2-2 2-2-2zM12 2l2 2-2 2-2-2 2-2zM4 8l2 2-2 2-2-2 2-2zM20 8l2 2-2 2-2-2 2-2zM12 22l2-2-2-2-2 2 2 2z"/>
                        </svg>
                      </div>
                      <div>
                        <div className="font-semibold">Chutes d'eau</div>
                        <div className="text-sm text-gray-600">Sites naturels spectaculaires</div>
                      </div>
                    </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <div>{tour.dates || 'Mai à Septembre'}</div>
                  </div>
...
function getCityDescription(city) {
  const descriptions = {
    'Luanda': 'Capitale économique et port principal',
    'Benguela': 'Ville historique, plages magnifiques',
    'Huambo': 'Plateau central, cœur agricole',
    'Lubango': 'Porte d\'entrée du désert du Namibe',
    'Namibe': 'Côte atlantique, désert unique',
    'Lobito': 'Baie naturelle exceptionnelle',
    'Malanje': 'Chutes de Kalandula, rochers noirs',
    'Uíge': 'Forêt tropicale, café',
    'Soyo': 'Delta du fleuve Congo, pétrole',
    'Parque da Kissama': 'Safari, faune africaine',
    'Chutes de Kalandula': 'Chutes majestueuses',
    'Kuito': 'Histoire récente, reconstruction',
    'Cabinda': 'Enclave riche en pétrole',
    'Sumbe': 'Côte centrale, plages préservées',
    'Porto Amboim': 'Port de pêche traditionnel',
    'Caxito': 'Vallée fertile',
    'Ndalatando': 'Centre administratif',
    'Tômbwa': 'Port de pêche, désert côtier',
    'Parque do Iona': 'Désert côtier unique',
  };
  return descriptions[city] || 'Ville angolaise';
}
...
function getRegionForCity(city) {
  const regions = {
    ...
    'Uíge': 'UÍGE',
    'Soyo': 'ZAIRE',
    'Parque da Kissama': 'BENGUELA',
    'Chutes de Kalandula': 'MALANJE',
    'Kuito': 'BIÉ',
    'Cabinda': 'CABINDA',
    'Sumbe': 'KWANZA SUL',
    ...
    'Tômbwa': 'NAMIBE',
    'Parque do Iona': 'NAMIBE',
  };
  return regions[city] || 'ANGOLA';
}

function getIncludedActivities(circuitId) {
  const activities = {
    'AGO1': [
      'Visite de Luanda et sa baie',
      'Excursion à Benguela et ses plages',
      'Découverte du port de Lobito',
      'Dégustation de fruits de mer frais',
    ],
    'AGO3': [
      'Circuit à travers le nord du pays',
      'Visite des chutes de Kalandula',
      'Découverte de la forêt tropicale',
      'Rencontres culturelles',
    ],
    'AGO4': [
      'Exploration du désert du Namibe',
      'Visite du Parc national d\'Iona',
      'Découverte de la faune désertique',
      'Observation des dunes uniques',
    ],
    'AGO6': [
      'Tour complet du sud de l\'Angola',
      'Découverte du Plateau Central',
      'Visite des villes historiques',
...
export default function Angola() {
  ...
  const tours = [
    {
      id: 'AGO1',
      name: 'Trésors de l\'Angola : De Luanda aux Plages de Benguela',
      ...
      salePrice: 2299,
      dates: 'MAI-SEPT',
      image: defaultCircuitImages['AGO1'],
      link: '/tresorangola'
    },
    {
      id: 'AGO2',
      name: 'Plateau Central : Huambo et les Hautes Terres',
      ...
      price: 2799,
      dates: 'JUIN-OCT',
      image: defaultCircuitImages['AGO2'],
      link: '/plateaucentre'
    },
    {
      id: 'AGO3',
      name: 'Nord Mystérieux : Forêts et Chutes Spectaculaires',
      ...
      includesAir: true,
      dates: '',
      image: defaultCircuitImages['AGO3'],
      link: '/nordangola'
    },
    {
      id: 'AGO4',
      name: 'Désert du Namibe et Côte Sauvage',
      ...
      includesAir: true,
      dates: 'AVR-NOV',
      image: defaultCircuitImages['AGO4'],
      link: '/desertnamibe'
    },
    {
      id: 'AGO5',
      name: 'Enclave de Cabinda et Delta du Congo',
      ...
      includesAir: true,
      dates: 'TOUTE ANNÉE',
      image: defaultCircuitImages['AGO5'],
      link: '/enclave'
    },
    {
      id: 'AGO6',
      name: 'Sud Authentique : Lubango et le Grand Sud',
      ...
      includesAir: true,
      dates: '',
      image: defaultCircuitImages['AGO6'],
      link: '/sudangola'
    },
    {
      id: 'AGO7',
      name: 'Côte Centrale : Plages et Histoire Coloniale',
      ...
      salePrice: 1699,
      dates: 'MAI-SEPT',
      image: defaultCircuitImages['AGO7'],
      link: '/coteangola'
    },
    {
      id: 'AGO8',
      name: 'Vallées Fertiles et Patrimoine Culturel',
      ...
      price: 1699,
      dates: 'MARS-NOV',
      image: defaultCircuitImages['AGO8'],
      link: '/valleefertile'
    },
    {
      id: 'AGO9',
      name: 'Safari au Parc National d\'Iona',
      duration: '7 Jours, 1 Pays',
      country: 'Angola',
      category: 'SAFARI',
      from: 'LUBANGO',
      ...
      includesAir: true,
      dates: 'MAI-OCT',
      image: defaultCircuitImages['AGO9'],
      link: '/safariiona'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url(${angolaHero})`,
          backgroundPosition: 'center 35%'
        }}
      >
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/20" />
        <div className="relative h-full flex items-center justify-center">
          <h1 className="text-6xl text-white font-serif tracking-wide">Circuits en Angola</h1>
        </div>
      </div>

      {/* Section Contenu */}
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-4xl font-serif mb-4">La Perle de l'Afrique Australe</h2>
        <p className="text-gray-700 text-base leading-relaxed mb-8 max-w-5xl">
          L'Angola, pays aux contrastes saisissants, offre une incroyable diversité de paysages allant des déserts du Namibe aux forêts tropicales du nord, des plages immaculées de l'Atlantique aux plateaux verdoyants du centre. Découvrez un pays en pleine renaissance, riche en histoire, culture et hospitalité. Des chutes majestueuses de Kalandula aux villes coloniales bien préservées, l'Angola vous réserve des expériences authentiques et inoubliables à travers nos circuits soigneusement conçus.
        </p>

        <h3 className="text-3xl font-serif mb-8">Découvrez la Richesse Angolaise avec les Circuits Globus</h3>
                    ...
                    <>
                      ...
                      <div className="space-y-2">
                        ...
                        <label className="flex items-center justify-between cursor-pointer hover:bg-gray-50 p-2">
                          <div className="flex items-center gap-2">
                            <input type="checkbox" className="w-4 h-4 border-gray-300" />
                            <span className="text-sm">Parque da Kissama</span>
                          </div>
                          <span className="text-sm text-gray-500">2</span>
                        </label>
                      </div>
                    ...
                    <>
                      ...
                      <div className="space-y-3">
                        <label className="flex items-start cursor-pointer hover:bg-gray-50 p-2">
                          ...
                          <div className="ml-2 flex-1">
                            <div className="flex justify-between items-start">
                              <span className="text-sm leading-snug">Découverte de l'Afrique Australe : Économisez 400 $ par couple sur les circuits Angola 2026*</span>
                        ...
                        <label className="flex items-start cursor-pointer hover:bg-gray-50 p-2">
                          ...
                          <div className="ml-2 flex-1">
                            <div className="flex justify-between items-start">
                              <span className="text-sm leading-snug">Aventure Angolaise : Économisez 300 $ par couple sur les circuits aventure*</span>
                        ...
                        <label className="flex items-start cursor-pointer hover:bg-gray-50 p-2">
                          ...
                          <div className="ml-2 flex-1">
                            <div className="flex justify-between items-start">
                              <span className="text-sm leading-snug">Économisez 30 $ supplémentaires par personne sur les circuits Angola 2026*</span>
                        ...
                        <a href={tour.link} className="block h-full">
                          <img 
                            ...
                            onError={(e) => {
                              ...
                              e.target.src = "https://images.unsplash.com/photo-1589552950456-75eeaf3c7b1e?w=800&q=80";
                            }}
                          />
                        </a>
                        {tour.dates && (

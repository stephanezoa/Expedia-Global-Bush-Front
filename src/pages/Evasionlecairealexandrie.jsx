...
export default function Evasioncairealexandrie() {
      ...
      <div className="relative h-[450px] bg-cover bg-center" style={{
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent">
          <div className="max-w-7xl mx-auto px-8 py-12">
            <h1 className="text-4xl md:text-5xl font-serif mb-6 text-white">Évasion du Caire et d'Alexandrie</h1>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              <div className="flex flex-wrap items-center gap-2 text-xs md:text-sm mb-2">
                ...
                <span className="bg-red-900 text-white px-3 py-1 font-bold">KQIX</span>
                <span className="mx-2 hidden md:inline">|</span>
                <span className="text-gray-600">Visite de 6 jours du Caire au Caire</span>
            ...
            {activeTab === 'apercu' && (
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-8 text-sm md:text-base">
                  Les mystères du Sphinx vous attendent lors de ces vacances hors saison en Égypte ! Profitez de vacances 
                  escortées au Caire et à Alexandrie. Visitez l'incroyable Grand Musée égyptien et émerveillez-vous devant le Sphinx 
                  et la Grande Pyramide de Gizeh—, la plus ancienne des sept merveilles du monde antique. Visitez le port 
                  méditerranéen du IVe siècle fondé par Alexandre le Grand à Alexandrie. Les visites guidées comprennent les 
                  catacombes de Kom El Shogafa, le pilier de Pompée et les luxuriants jardins de Montazah. Voyagez à travers le 
                  désert d'El Beheira en route vers Wadi el Natrun pour visiter le monastère copte. Ces vacances guidées de 6 jours 
                  en Égypte sont encore meilleures avec moins de foules et plus d'économies pendant l'intersaison—à merveilleuse 
                  évasion pour être sûr !
                </p>
                ...
                <div className="border-l-4 border-red-900 pl-6 mb-10">
                  ...
                  <ul className="list-none space-y-2 text-gray-700 text-sm md:text-base">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-red-900 mt-1">•</span>
                      <span>La visite de l'oasis de Wadi El Natrun comprend une visite d'un monastère copte</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-900 mt-1">•</span>
                      <span>Visite guidée touristique à Alexandrie</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-red-900 mt-1">•</span>
                      <span>Promenade panoramique dans le désert</span>
                    </li>
                  </ul>
                </div>

                {/* Section Circuits similaires - Nouveau placement */}
                <div className="mb-10">
                ...
                {/* Section Circuits similaires supprimée ici */}
              </div>
            )}
